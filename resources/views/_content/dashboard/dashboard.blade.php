    ...
    <div id="kt_app_content_container" class="app-container  container-fluid ">
        ...
        <div class="row g-5 gx-xl-10 mb-5 mb-xl-10">
            ...
            <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                ...
                <!--layout-partial:partials/widgets/cards/_widget-7.html--> @include('partials.widgets.cards._widget-7')
            </div>
            <!--end::Col-->
            <!--begin::Col-->
            <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
            ...
            <!--begin::Col-->
            <div class="col-xxl-6">
                <!--layout-partial:partials/widgets/engage/_widget-10.html-->@include('partials.widgets.engage._widget-10')
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
        ...
        <div class="row gx-5 gx-xl-10">
            ...
            <div class="col-xl-4 mb-5 mb-xl-0">
                <!--layout-partial:partials/widgets/charts/_widget-31.html-->@include('partials.widgets.charts._widget-31')
            </div>
            <!--end::Col-->
            <!--begin::Col-->
            <div class="col-xl-8">
