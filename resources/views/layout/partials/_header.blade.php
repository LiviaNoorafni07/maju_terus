...
<!--layout-partial:layout/partials/header/_menu/_menu.html--> @include('layout.partials.header._menu._menu')
<!--layout-partial:layout/partials/header/_navbar.html--> @include('layout.partials.header._navbar')
</div>
