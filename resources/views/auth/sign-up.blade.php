						...
						<div class="w-lg-500px p-10">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="/dashboard" action="#">
								...
								<div class="text-center mb-11">
									...
									<!--end::Title-->
									<!--begin::Subtitle-->
									<div class="text-gray-500 fw-semibold fs-6">Selamat Datang Pemula!</div>
									<!--end::Subtitle=-->
								</div>
								<!--begin::Heading-->
								{{-- <!--begin::Login options-->
								...
								<div class="fv-row mb-8">
									...
									<input placeholder="Ketik Kembali Password Kamu" name="confirm-password" type="password" autocomplete="off" class="form-control bg-transparent" />
									<!--end::Repeat Password-->
								</div>
								<!--end::Input group=-->
								<!--begin::Accept-->
