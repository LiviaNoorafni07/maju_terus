						...
						<div class="w-lg-500px p-10">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../dashboard" action="#">
								...
								<div class="text-center mb-11">
									...
									<!--end::Title-->
									<!--begin::Subtitle-->
									<div class="text-gray-500 fw-semibold fs-6">Selamat Datang Kembali!</div>
									<!--end::Subtitle=-->
								</div>
								<!--begin::Heading-->
								{{-- <!--begin::Login options-->
								...
								<div class="fv-row mb-8">
									<!--begin::Email-->
									<input type="text" placeholder="Masukan Email" name="email" autocomplete="off" class="form-control bg-transparent" id="email"/>
									<!--end::Email-->
								</div>
								<!--end::Input group=-->
								<div class="fv-row mb-3">
									<!--begin::Password-->
									<input type="password" placeholder="Maukan Password" name="password" autocomplete="off" class="form-control bg-transparent" id="password"/>
									<!--end::Password-->
								</div>
								<!--end::Input group=-->
								<!--begin::Wrapper-->
								...
								<!--end::Submit button-->
								<!--begin::Sign up-->
								<div class="text-gray-500 text-center fw-semibold fs-6">Belum menjadi member ?
								<a href="../../demo1/dist/authentication/layouts/corporate/sign-up.html" class="link-primary">Daftar</a></div>
								<!--end::Sign up-->
							</form>
							<!--end::Form-->
						</div>
				...
				<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(assets/media/misc/auth-bg.png)">
					...
					<div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
						...
						<a href="../../demo1/dist/index.html" class="mb-0 mb-lg-12">
							<img alt="Logo" src="assets/media/logos/logopsp2.png" class="h-60px h-lg-75px" />
						</a>
						<!--end::Logo-->
						<!--begin::Image-->
